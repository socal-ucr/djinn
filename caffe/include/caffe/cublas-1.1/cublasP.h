...
#define CUBLAS_GET_CTX() NULL

//__tlsHookInitTlsValueForcublasThreadContext(cublasInitCtx, cublasShutDownCtx)
...
void cublasSmallSgemm (struct cublasContext *ctx, char transa, char transb, 
                       ...
                       int ldc);
void cublasFastSgemm (int tblimit, struct cublasContext *ctx, char transa, char transb,
                      int m, int n, int k, float alpha, const float *A, 
                      int lda, const float *B, int ldb, float beta, float *C, 
                      int ldc);
void cublasLargeSgemm (int tblimit, struct cublasContext *ctx, char transa, char transb, 
                       int m, int n, int k, float alpha, const float *A, 
                       int lda, const float *B, int ldb, float beta, float *C, 
                       int ldc);
void cublasFastCgemm (struct cublasContext *ctx, char transa, char transb, 
                      ...
                      cuComplex *C, int ldc);
void cublasLargeDgemm (struct cublasContext *ctx, char transa, char transb, 
