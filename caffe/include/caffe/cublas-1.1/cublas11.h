...
#define CUBLAS_OP_C 'C'
#if defined(__cplusplus)
#include "cuComplex11.h"   /* import complex data type */
using namespace cublas11;
extern "C" {
#endif /* __cplusplus */
 ...
 * CUBLAS_STATUS_EXECUTION_FAILED if function failed to launch on GPU
 */
void CUBLASAPI cublasSgemm (int tblimit,char transa, char transb, int m, int n, int k, 
                            float alpha, const float *A, int lda, 
