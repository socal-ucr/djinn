...
#include <ctype.h>
#include <math.h>
#include "caffe/cublas-1.1/cublas11.h"
 ...
 */
__host__ void CUBLASAPI cublasSgemm (int tblimit, char transa, char transb, int m, int n,
                                     ...
                                     float beta, float *C, int ldc)
{
    ...
    if (useFastImul) {
        cublasFastSgemm (tblimit, ctx, transa, transb, m, n, k, alpha, A, lda, B, ldb, 
                         beta, C, ldc);
        return;
    }        
    ...
    cublasLargeSgemm (tblimit, ctx, transa, transb, m, n, k, alpha, A, lda, B, ldb, 
                      beta, C, ldc);
}
