...
__shared__ double AA[(TILE_DIM+1)*TILE_DIM]; /*pad to elim. GRF bank conflicts*/
__shared__ double BB[(TILE_DIM+1)*TILE_DIM]; /*pad to elim. GRF bank conflicts*/
...
#define FAST_IMUL         0
#define USE_TEX           0
#include "caffe/cublas-1.1/dgemm.h"
}
